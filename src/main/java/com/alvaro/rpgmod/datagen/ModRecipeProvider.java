...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder{
    ...
    protected static void nineBlockStorageRecipes(Consumer<FinishedRecipe> p_250423_, RecipeCategory p_250083_, ItemLike p_250042_, RecipeCategory p_248977_, ItemLike p_251911_, String p_250475_, @Nullable String p_248641_, String p_252237_, @Nullable String p_250414_) {
        ShapelessRecipeBuilder.shapeless(p_250083_, p_250042_, 9).
                ...
                .save(p_250423_, new ResourceLocation(RPGMod.MODID, p_252237_));
        ShapedRecipeBuilder.shaped(p_248977_, p_251911_)
                ...
                .save(p_250423_, new ResourceLocation(RPGMod.MODID, p_250475_));
     }
     ...
     protected static void Cooking(Consumer<FinishedRecipe> p_250791_, RecipeSerializer<? extends AbstractCookingRecipe> p_251817_, List<ItemLike> p_249619_, RecipeCategory p_251154_, ItemLike p_250066_, float p_251871_, int p_251316_, String p_251450_, String p_249236_) {
        for(ItemLike itemlike : p_249619_) {
           SimpleCookingRecipeBuilder.generic(Ingredient.of(itemlike), p_251154_, p_250066_, p_251871_, p_251316_, p_251817_)
                    ...
                    .save(p_250791_, new ResourceLocation(RPGMod.MODID, getItemName(p_250066_)) + p_249236_ + "_" + getItemName(itemlike));
        }
     ...
     protected static void planksFromLogs(Consumer<FinishedRecipe> consumer, ItemLike plank, ItemLike logs, int result) {
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, plank, result)
                 ...
                 .unlockedBy("has_logs", inventoryTrigger(ItemPredicate.Builder.item()
                         .of(logs).build()))
                 .save(consumer, new ResourceLocation(RPGMod.MODID, getItemName(plank) + "_from_" + getItemName(logs)));
     }
     ...
     protected static void woodFromLogs(Consumer<FinishedRecipe> p_126003_, ItemLike p_126004_, ItemLike p_126005_) {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, p_126004_, 3)
            ...
            .save(p_126003_, new ResourceLocation(RPGMod.MODID, getItemName(p_126004_) + "_from_" + getItemName(p_126005_)));
     }
     ...
     protected static void swordRecipe(Consumer<FinishedRecipe> consumer, ItemLike ore, ItemLike base, ItemLike result){
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, result)
                 ...
                 .save(consumer, new ResourceLocation(RPGMod.MODID, getItemName(ore) + "_sword"));
     }
     ...
     protected static void pickaxeRecipe(Consumer<FinishedRecipe> consumer, ItemLike ore, ItemLike base, ItemLike result){
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, result)
                 ...
                 .unlockedBy("has_" + getItemName(ore), inventoryTrigger(ItemPredicate.Builder.item()
                         .of(ore).of(base).build()))
                 .save(consumer, new ResourceLocation(RPGMod.MODID, getItemName(ore) + "_pickaxe"));
     }
     protected static void hoeRecipe(Consumer<FinishedRecipe> consumer, ItemLike ore, ItemLike base, ItemLike result){
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, result)
                 ...
                 .unlockedBy("has_" + getItemName(ore), inventoryTrigger(ItemPredicate.Builder.item()
                         .of(ore).of(base).build()))
                 .save(consumer, new ResourceLocation(RPGMod.MODID, getItemName(ore) + "_hoe"));
     }
     protected static void shovelRecipe(Consumer<FinishedRecipe> consumer, ItemLike ore, ItemLike base, ItemLike result){
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, result)
                 ...
                 .unlockedBy("has_" + getItemName(ore), inventoryTrigger(ItemPredicate.Builder.item()
                         .of(ore).of(base).build()))
                 .save(consumer, new ResourceLocation(RPGMod.MODID, getItemName(ore) + "_shovel"));
     }
     protected static void axeRecipe(Consumer<FinishedRecipe> consumer, ItemLike ore, ItemLike base, ItemLike result){
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, result)
                 ...
                 .unlockedBy("has_" + getItemName(ore), inventoryTrigger(ItemPredicate.Builder.item()
                         .of(ore).of(base).build()))
                 .save(consumer, new ResourceLocation(RPGMod.MODID, getItemName(ore) + "_axe"));
     }
